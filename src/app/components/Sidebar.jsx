      ...
      <AnimatePresence mode="wait" initial={false}>
        {open && (
          <>
            ...
            <motion.div
              {...framerSidebarPanel}
              className="fixed top-0 bottom-0 left-0 z-50 w-full h-screen max-w-xs border-r-2 border-zinc-800"
              ref={ref}
              aria-label="Sidebar"
            >
                  ...
                  return (
                    <li key={title}>
                      <a
                        onClick={toggleSidebar}
                        href={href}
                        className="flex items-center justify-between gap-5 p-5 transition-all border-b-2 hover:bg-zinc-100 border-zinc-800"
                      >
